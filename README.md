...
Cut using file generated by [map style shown in the section above](https://matkoniecz.github.io/lunar_assembler/examples/laser_road_crossing_closeup_map_style.html).
