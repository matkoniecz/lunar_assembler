...
[Ultra-high zoom map for showing a single crossing](https://matkoniecz.github.io/lunar_assembler/examples/laser_road_area.html), relying on area:highway.
...
Cut using file generated by [map style shown in the section above](https://matkoniecz.github.io/lunar_assembler/examples/laser_road_area.html).
